...
object Sem1Chap04CourseMaterial : CourseMaterial {
    ...
    override val lessons = listOf(
        ...
        LessonMaterial(level = 4, prompt = "that thing over there", response = "あれ"),
        ...
        LessonMaterial(level = 4, prompt = "this thing", response = "これ"),
        ...
        LessonMaterial(level = 4, prompt = "that thing", response = "それ"),
