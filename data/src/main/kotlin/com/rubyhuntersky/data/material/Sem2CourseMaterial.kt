...
object Sem2CourseMaterial : CourseMaterial {
    ...
    override val lessons = listOf(
        ...
        LessonMaterial(level = 11, prompt = "n cups", promptColor = "filled container counter", response = "〜はい", responseColor = "pai: いっぱい　ろっぱい　はっぱい　じゆっぱい\nbai: さんばい　なんばい"),
        ...
        LessonMaterial(level = 11, prompt = "be pleased, be delighted", response = "よろこぶ", responseColor="u verb"),
        ...
        LessonMaterial(level = 11, prompt = "It's popular.", response = "人きがあります。", responseColor = "It has popularity."),
